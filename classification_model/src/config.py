...
class Config(object):
    def __init__(self, args):
        ...
        self._config = config
        self.train_file = './data/train_' + str(args.fold) + '.data.pickle'
        self.dev_file = './data/dev_' + str(args.fold) + '.data.pickle'
        self.test_file = './data/test_' + str(args.fold) + '.data.pickle'
        ...
        self.save_dir = './res/' + args.w + '.' + str(args.loss) + '/' + str(args.fold)
    ...
    @property
    def save(self):
        return self._config.getboolean('Save', 'res')
