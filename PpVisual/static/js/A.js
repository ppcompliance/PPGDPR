(function () {
    ...
    //     // var aa= document.getElementById("text").innerHTML;
    //     // console.log("1",aa);
    //     var bb =["apps","Computer","Opera"];
    //     for(var i=0;i<bb.length;i++){
    //         // console.log(bb[i]);
    //         var reg = new RegExp("(" + bb[i] + ")", "g");
    //         str = str.replace(reg,"<font style='background:#ffd2cc;'>$1</font>");
    //         console.log(str);
    //     }
