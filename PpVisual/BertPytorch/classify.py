...
import BertPytorch.tokenization as tokenization
import BertPytorch.models as models
import BertPytorch.optim as optim
import BertPytorch.train as train

from BertPytorch.utils import set_seeds, get_device, truncate_tokens_pair
...
def main_classify(task='pp',
         train_cfg='BertPytorch/config/train_mrpc.json',
         model_cfg='BertPytorch/config/bert_base.json',
         data_file='BertPytorch/glue_data/file_test.tsv',
         model_file='BertPytorch/save/model_steps_0.pt',
         pretrain_file='BertPytorch/model/bert_model.ckpt',
         data_parallel=True,
         vocab='BertPytorch/model/vocab.txt',
         save_dir='BertPytorch/save/',
         max_len=128,
         mode='eval'):
    ...
    loss_weight = loss_weight.to(torch.device('cuda', 0))
    ...
    if mode == 'train':
        ...
        resultwriter = open("./BertPytorch/save/predict_result.tsv", 'w', encoding="utf-8")
