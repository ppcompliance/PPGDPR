...
def scrape_info(url, chinese=True):
    ...
    if gplay_id:
        ...
        item['gplay_id'] = ''
    appname = selector.xpath('//*[@id="fcxH9b"]/div[4]/c-wiz/div/div[2]/div/div/main/c-wiz[1]/c-wiz[1]/div/div[2]/div/div[1]/c-wiz[1]/h1/span/text()')
    if (len(appname) > 0):
        appname = appname[0]
    # a = type(appname)
    # print(a)
    ...
    categories = selector.xpath(
        '//*[@id="fcxH9b"]/div[4]/c-wiz/div/div[2]/div/div/main/c-wiz[1]/c-wiz[1]/div/div[2]/div/div[1]/div/div[1]/div[1]/span[2]/a/text()')
    if len(categories) > 0:
