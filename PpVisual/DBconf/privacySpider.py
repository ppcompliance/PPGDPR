...
class privacySpider:
    ...
    def get_privacy(self, privacy_url, pp_id, app_id, name, **db_config):
        ...
        if pp_id < 0:
            ...
            privacy_info = df_read.iloc[0]
            # privacy_text = privacy_info['text']
            # print("privacy_text",privacy_text)
            # print(type(privacy_info))

            return privacy_info, False
            # except:
